...
win32 {
    BOOST_LIB_SUFFIX=-mgw83-mt-s-1_55
    BOOST_INCLUDE_PATH=C:/deps/64bit/boost_1_55_0
    BOOST_LIB_PATH=C:/deps/64bit/boost_1_55_0/stage/lib
    BDB_INCLUDE_PATH=C:/deps/64bit/db-4.8.30.NC/build_unix
    BDB_LIB_PATH=C:/deps/64bit/db-4.8.30.NC/build_unix
    OPENSSL_INCLUDE_PATH=C:/deps/64bit/openssl-1.0.2q/include
    OPENSSL_LIB_PATH=C:/deps/64bit/openssl-1.0.2q
    MINIUPNPC_INCLUDE_PATH=C:/deps/64bit/
...
macx:ICON = src/qt/res/icons/Libra.icns
macx:TARGET = "LibraCoin-Qt"
